...
local tile_left =  awful.layout.suit.tile.left
local tile_bottom = awful.layout.suit.tile.bottom
local tile_top = awful.layout.suit.tile.top
local fair = awful.layout.suit.fair
local fair_horizontal = awful.layout.suit.fair.horizontal
...
if beautiful.wallpaper then
    gears.wallpaper.maximized(beautiful.wallpaper, main_screen, true)
    gears.wallpaper.maximized(beautiful.wallpaper2, second_screen, true)
end
-- }}}
...
tags[second_screen] = awful.tag(tags_second.names, second_screen, tags_second.layout)
-- }}}
